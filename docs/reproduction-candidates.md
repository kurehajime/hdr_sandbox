# success_sample.png 再現候補の生成手順（第9版）

更新日: 2026-03-07 (v9: threshold zoom matrix 追加)
...
- 次段は、alpha/luma 2Dマトリクス + iso-effective triplet + threshold zoom matrix を使い、**境界形状と積モデルの均一性／局所非線形**を同時観測する方針とする
